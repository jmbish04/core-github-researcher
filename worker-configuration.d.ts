/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5e855625765e528ca4a9aa67aeb010a5)
// Runtime types generated with workerd@1.20260128.0 2026-02-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CodeResearchAgent" | "ResearchAgent";
	}
	interface Env {
		DB: D1Database;
		ASSETS: Fetcher;
		...
		CODE_RESEARCH_AGENT: DurableObjectNamespace<import("./src/index").CodeResearchAgent>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_TOKEN" | "OPENAI_API_KEY">> {}
}
